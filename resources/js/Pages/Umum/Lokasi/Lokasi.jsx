...
const Lokasi = () => {
  ...
  <meta name="description" content={content} />
        ...
        <HeaderTitleUmum images={'images/bg-lokasi.jpg'} title={'Lokasi Warehouse'} subTitle={' google map dari warehouse dan bentuk fisiknya'} />
            <BigMxWrapper>
                <div className="flex flex-col xl:flex-row justify-between py-10 ">
                    <div className="  xl:w-[30vw] py-4 xl:px-3 flex flex-col justify-evenly gap-5 items-center">
                        <img
                    ...
                    <div className="  xl:w-[30vw] py-4 px-3 flex flex-col justify-evenly gap-5 items-center">
                        <iframe
