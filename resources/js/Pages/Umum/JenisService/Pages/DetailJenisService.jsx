...
const DetailJenisService = ({ JenisService, otherJenisServices }) => {
    return (
        <UmumLayout>
            <BigMxWrapper >
                <div className="flex flex-col h-full lg:flex-row gap-10 mx-4 justify-between">
                    <div className="flex flex-col gap-4 pt-9 px-4 w-15 items-center bg-stone-200">
                        <div className="w-12 rounded mx-auto flex justify-center">
                            <img src={"/storage/" + JenisService.icon} />
                        </div>
                        <div className="flex flex-col gap-4 lg:mt-3 bg-stone-200 backdrop-blur-sm py-4 rounded-md w-full items-center justify-end lg:px-4">
                            <FacebookLink />
                            <TwiterLink />
                            <InstagramLink />
                        </div>
                    </div>
                    <div className="flex-initial w-[80vw] px-10 break-words py-6 border-x-2 border-stone-200 shadow-inner">
                        <div>
                        ...
                        <div className="flex flex-col gap-6 py-10 ">
                            ...
                            {otherJenisServices.map((data, key) => (
                                <Link
                                    ...
                                    key={key}
                                    className="bg-stone-200 rounded-md shadow-lg overflow-hidden break-words lg:w-[16vw]"
                                >
