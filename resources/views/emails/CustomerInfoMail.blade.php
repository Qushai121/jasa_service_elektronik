                                    ...
                                    <tr>
                                        <td style="font-family: sans-serif; font-size: 14px; vertical-align: top;"
                                            ...
                                            <p
                                                ...
                                                Halo {{ $datas['customers']['nama'] }} ,</p>
                                            <p
                                                style="font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; margin-bottom: 15px;">
                                                Barang anda yang berupa {{ $datas['nama_barang'] }} Sudah Selesai Di Service.</p>
                                            
                                            <p
                                                style="font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; margin-bottom: 15px;">
                                                Silahkan Datang Dan Ambil Barangnya</p>
                                            <p
                                                style="font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; margin-bottom: 15px;">
                                                Terimakasih Sudah Menggunakan Jasa kami.</p>
                                        </td>
                                    </tr>
                                </table>
                            </td>
                            ...
                            <tr>
                                <td class="content-block"
                                    ...
                                    <span class="apple-link"
                                        style="color: #999999; font-size: 12px; text-align: center;">uhuy.ltd, 3
